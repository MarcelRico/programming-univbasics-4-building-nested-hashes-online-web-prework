...
def monopoly_with_fourth_tier
  ...
  new_has[:railroads][:names][:pennsylvania_railroad][:mortgage_value] = "$100"
  new_has[:railroads][:names][:b_and_o_railroad][:mortgage_value] = 100
  new_has[:railroads][:names][:shortline_railroad][:mortgage_value] = 100
end
